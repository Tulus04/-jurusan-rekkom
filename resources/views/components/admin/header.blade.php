{{--
|--------------------------------------------------------------------------
| Komponen Header Admin (dari CoreUI index.html baris 223-338)
|--------------------------------------------------------------------------
| Mengikuti persis struktur header template:
| toggle button, nav links, notification icons, theme switcher,
| avatar dropdown, breadcrumb.
|--------------------------------------------------------------------------
--}}
<header class="header header-sticky p-0 mb-4">
    <div class="container-fluid border-bottom px-4">

        {{-- Toggle sidebar button (persis dari template) --}}
        ...
        {{-- Notification icons (dari template) --}}
        ...
        <ul class="header-nav">
            ...
            {{-- Theme switcher (persis dari template) --}}
            ...
            {{-- User avatar dropdown (dari template) --}}
            <li class="nav-item dropdown">
                <a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                    aria-expanded="false">
                    <div class="avatar avatar-md">
                        <img class="avatar-img" src="{{ asset('admin/img/avatars/8.jpg') }}"
                            alt="{{ Auth::user()->name ?? 'Admin' }}">
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold rounded-top mb-2">Akun
                    </div>
    ...
    {{-- Breadcrumb (persis dari template) --}}
